            ...
            <tbody>
                ...
                ?>
                    <tr class="<?php echo $class; ?>">
                        <td><?php echo $no++ ?></td>
                        <td><a href="detailPelanggan4.php?id_pelanggan=<?php echo $row['id_pelanggan'] ?>"><?php echo $row['nama_pelanggan'] ?></a></td>
                        ...
                        <td>
                            <a href="editPenitipan4.php?id_penitipan=<?php echo $row['id_penitipan'] ?>"><button class="pill">Edit</button></a>
                            <a href="deletePenitipan4.php?id_pelanggan=<?php echo $row['id_pelanggan'] ?>"><button class="pill pill-hapus">Hapus</button></a>
                        </td>
                    </tr>
                <?php
                }
