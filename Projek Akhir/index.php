            ...
            <div class="navbar-button">
                <ul>
                    <div class="navbar-button-sign">
                        <li><a href="login.php">Sign In<i class="fas fa-sharp fa-solid fa-arrow-right-from-bracket"></i></a></li>
                    </div>
                </ul>
            </div>
        </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="item">
                                ...
                                <h3>Grooming</h3>
                                <p>Kami potong rambut, kuku, dan bulu mata hewan peliharaan Anda sesuai keinginan Anda. Kami gunakan alat steril dan profesional untuk hasil rapi dan cantik.</p>
