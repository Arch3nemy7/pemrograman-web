                ...
                <nav>
                    <ul>
                        <div class="navbar-links-btn">
                            <a href="index2.php#beranda">
                                <li>Beranda</li>
                            </a>
                        </div>
                        <div class="navbar-links-btn">
                            <a href="index2.php#layanan">
                                <li>Layanan</li>
                            </a>
                        </div>
                        <div class="navbar-links-btn">
                            <a href="index2.php#dokter">
                                <li>Dokter</li>
                            </a>
                        </div>
                        <div class="navbar-links-btn">
                            <a href="index2.php#kontak">
                                <li>Kontak</li>
                            </a>
                        </div>
                        <div class="navbar-links-btn">
        ...
        <div class="wrapper">
            ...
            <table class="content-table">
                ...
                <tbody>
                    ...
                    $sql = "SELECT DISTINCT p.id_penitipan, pl.id_pelanggan, pl.nama_pelanggan, h.nama_peliharaan, h.jenis_hewan, p.status_penitipan, p.file_path, h.catatan, py.total_pembayaran, py.status_pembayaran
                            FROM penitipan p
                            ...
                            WHERE pl.id_pelanggan = $id_pelanggan
                    ...
                    ?>
                        <tr class="<?php echo $class; ?>">
                            ...
                            <td>
                                <a href="editPenitipan2.php?id_penitipan=<?php echo $row['id_penitipan'] ?>"><button class="pill">Edit</button></a>
                                <a href="deletePenitipan2.php?id_pelanggan=<?php echo $id_pelanggan ?>"><button class="pill pill-hapus">Cancel</button></a>
                            </td>
                        </tr>
                    <?php
                    }
